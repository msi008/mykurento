 ...
 */
function register() {
    var myname = getCookie('tt-hoozhaname') || randomString(6);
    setCookie('tt-hoozhaname',myname);
    ...
    sendMessage(data);
    joinRoom(location.pathname.replace(/\//g,''));
    var AppID     = "789526644";
    var AppSecret = "hMN3BawDeVV+5Xo6kPpyupAGmwdpdThnPyKihN63hkk=";
    window.callStats = new callstats(null,io,jsSHA);
    callStats.initialize(AppID, AppSecret, myname, function(){}, function(){});
}
