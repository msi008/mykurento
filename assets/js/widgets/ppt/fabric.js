...
fabric.Collection = {
   ...
   * @chainable
   */
  insertAt: function (object, index, nonSplicing, complete) {
    ...
    this._onObjectAdded(object, complete);
    this.renderOnAddRemove && this.renderAll();
    return this;
  },

  toObjects : function(objs){
      var objects = Array();
      if(!!objs){
        for(var i= 0, length = objs.length;i<length;i++){
           objects.push(objs[i].toJSON());
        }
      }
      return objects;
  },
  ...
  remove: function() {
    ...
    for (var i = 0, length = arguments.length; i < length; i++) {
      obj = arguments[i];
      //if(!!obj && typeof obj.optype != "undefined") obj = obj.toJSON();
      //!!obj && typeof obj.optype != "undefined" && delete obj.optype;
      //objects = this.toObjects(objects);
    ...
    this.renderOnAddRemove && this.renderAll("removed");
    return this;
  },

  removed: function(obj, type) {
    var objects = this.getObjects(),
        index;
    ...
    if (index !== -1) {
      objects.splice(index, 1);
      this._onObjectRemoved(obj, type);
    }
    this.renderOnAddRemove && this.renderAll("removed");
    return this;
  },
...
(function () {
  ...
  fabric.StaticCanvas = fabric.util.createClass(/** @lends fabric.StaticCanvas.prototype */ {
     ...
     * @chainable true
     */
    setViewportTransform: function (vpt, type) {
     ...
     * @chainable true
     */
    zoomToPoint: function (point, value, type) {
     ...
     * @chainable true
     */
    setZoom: function (value, center, type) {
      var top = !!center ? center.y : 0,
          left = !!center ? center.x : 0;
      this.zoomToPoint(new fabric.Point(left,top), value, type);
      return this;
    },
     ...
     */
    _onObjectAdded: function(obj, complete) {
     ...
     */
    _onObjectRemoved: function(obj, type) {
     ...
     * @chainable
     */
    renderAll: function (type) {
      var canvasToDrawOn = this.contextContainer, objsToRender;
      //this.getActiveObject() 解决拖动不清问题
      if (this.contextTop  && (this.selection || !!this.getActiveObject()) && !this._groupSelector && !this.isDrawingMode) {
          this.clearContext(this.contextTop);
          this.clearContext(canvasToDrawOn);
      }

      if(type == "refresh" || type == "modified" || type =="removed" || type == "zoom" || type == "drag" || type == "undo" || type == "redo"){
        this.clearContext(canvasToDrawOn);
      }
...
fabric.util.object.extend(fabric.StaticCanvas.prototype, /** @lends fabric.StaticCanvas.prototype */ {
  ...
  loadFromJSON: function (json, callback, reviver) {
    ...
    if(typeof json.ptype != "undefined" && json.ptype == "modified" || json.ptype == "removed" || json.ptype == "zoom" || json.ptype == "drag"){
        this.clear();
    }
  ...
  _enlivenObjects: function (objects, callback, reviver) {
    ...
    fabric.util.enlivenObjects(objects, function(enlivenedObjects) {
      enlivenedObjects.forEach(function(obj, index) {
        var complete =  typeof objects.complete != "undefined" ? true : false;
        _this.insertAt(obj, index, true, complete);
      });
...
(function() {
  ...
  fabric.util.object.extend(fabric.Object.prototype, /** @lends fabric.Object.prototype */ {
    ...
    drawControls: function(ctx) {
      ...
      //if (!this.get('lockUniScaling')) {
      if (['rect','circle','triangle','text'].indexOf(this.type)!=-1) {
    ...
    _drawControl: function(control, ctx, methodName, left, top) {
      ...
      if (this.isControlVisible(control)) {
        ...
        case 'mtr':        
            ...
            ctx.drawImage(SelectedIconImage, left, top-7, sizeX, sizeY);
            break;
        default:
            break;
        }
...
fabric.util.object.extend(fabric.IText.prototype, /** @lends fabric.IText.prototype */ {
  ...
  initHiddenTextarea: function(e) {
    ...
    fabric.util.addListener(this.hiddenTextarea, 'focus', this.onFocus.bind(this));
