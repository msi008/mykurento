...
function AppParticipant(stream) {
    ...
    function playVideo() {
		...
		icons.className = "icons icons-enlarge";
		var option_btn = document.createElement('span');
		option_btn.className = "option-btn";
        option_btn.setAttribute('node-type', '_btn_enlarge_narrow');
...
function Participants() {
    ...
    this.addLocalParticipant = function (stream) {
        localParticipant = that.addParticipant(stream,function (src){
        	console.log('222222222222src::::::::::'+src);
        });
