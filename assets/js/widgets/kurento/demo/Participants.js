 ...
 *
 */
function AppParticipant(stream, callback) {
    ...
    function playVideo() {
        ...
        that.videoElement.className = "video-item";
        document.getElementById("participants").appendChild(that.videoElement);
    	that.stream.playOnlyVideo(that.videoElement,that.thumbnailId);
    	that.callback(that.stream.getUrl());
    	
		var icons = document.createElement('i');
		icons.className = "icons icons-narrow";
		var option_btn = document.createElement('span');
		option_btn.className = "option-btn";
		var option_body = document.createElement('span');
		option_body.className = "option-body clearfix";
		var video_option_box = document.createElement('div');
		video_option_box.className = "video-option-box";
		
		option_btn.appendChild(icons);
		option_body.appendChild(option_btn);
		video_option_box.appendChild(option_body);
		document.getElementById(that.thumbnailId).appendChild(video_option_box);
...
//        console.log(that.videoElement,'--212');
//        //把流渲染到页面
//        document.getElementById("participants").appendChild(that.videoElement);
...
function Participants() {
    ...
    this.addParticipant = function (stream) {
        ...
        var participant = new AppParticipant(stream, function(url){
